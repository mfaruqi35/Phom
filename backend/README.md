# Phom Backend (Hono) — API Documentation

*   **Port Lokal**: `3001`
*   **Base URL (Local)**: `http://localhost:3001`
*   **Base URL (Production)**: `https://phom-backend.onrender.com`
*   **Swagger Docs (Local)**: [http://localhost:3001/docs](http://localhost:3001/docs)
*   **Swagger Docs (Production)**: [https://phom-backend.onrender.com/docs](https://phom-backend.onrender.com/docs)
...
| `Origin` | `http://localhost:3001` (local) atau `https://phom-thesis.vercel.app` (prod) |
...
> **Catatan Testing (Postman):** Semua request ke `/api/auth/*` wajib menyertakan header `Origin: http://localhost:3001` (untuk testing lokal) atau `https://phom-thesis.vercel.app` (untuk testing production). Browser mengirim header ini secara otomatis, tetapi Postman tidak.
...
| `Origin`       | `http://localhost:3001` atau `https://phom-thesis.vercel.app` |
