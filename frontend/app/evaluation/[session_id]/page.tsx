      ...
      <main className="flex-1 w-full max-w-[1240px] mx-auto px-4 md:px-6 py-10 flex flex-col gap-8 z-10 print:py-0 print:px-0">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-5 space-y-8 flex flex-col">
            ...
            <div className="bg-white rounded-2xl border border-[#C7C4D8]/50 p-6 md:p-7 shadow-sm flex flex-col sm:flex-row items-center gap-6 animate-card-1 print:border-gray-200">
              ...
              <div className="relative w-36 h-36 flex items-center justify-center flex-shrink-0">
                ...
                <div className="absolute text-center">
                  ...
                  <span className="text-[9px] text-gray-400 block font-bold font-mono tracking-wider mt-0.5">SKOR AKHIR</span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-2.5 flex-1">
                <div className="flex items-center gap-2">
                  <span className="text-emerald-700 bg-emerald-50 px-3 py-0.5 rounded-full text-[9px] font-bold border border-emerald-100/50 flex items-center gap-1 print:border-black print:text-black print:bg-white">
                ...
                <p className="text-[11px] text-gray-500 leading-relaxed">
                  Komite penguji AI menilai tingkat argumentasi dan penguasaan naskah Anda berada di kategori kelayakan **{scores.grade}**.
                </p>
            ...
            {/* NEW WIDGET: Defense Readiness Indicators */}
            <div className="bg-white rounded-2xl border border-[#C7C4D8]/50 p-6 shadow-sm space-y-4 animate-card-3">
              ...
              <div className="space-y-3.5">
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-[11px] font-bold text-gray-600">
                    ...
                    <span className="text-emerald-600">85% (Sangat Siap)</span>
                  </div>
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-[11px] font-bold text-gray-600">
                    ...
                    <span className="text-[#3525cd]">78% (Siap)</span>
                  </div>
                  <div className="h-1.5 w-full bg-gray-100 rounded-full overflow-hidden">
                    <div className="h-full bg-[#3525cd] rounded-full" style={{ width: "78%" }}></div>
                  </div>
                </div>
                ...
                <div className="space-y-1">
                  <div className="flex justify-between text-[11px] font-bold text-gray-600">
                    ...
                    <span className="text-indigo-400">72% (Cukup)</span>
                  </div>
                  <div className="h-1.5 w-full bg-gray-100 rounded-full overflow-hidden">
              ...
              <div className="p-3 bg-emerald-50/30 rounded-xl border border-emerald-100/50 text-[10px] text-gray-500 leading-relaxed">
                <strong>Catatan Utama:</strong> Pertahankan intonasi tenang saat menjawab sanggahan kritis, dan pastikan Anda menguasai batasan sampel secara mendalam untuk menutupi kelemahan metodologi.
              </div>
            </div>
          ...
          <div className="lg:col-span-7 space-y-8 flex flex-col">
            ...
            {/* 3. Three Dimension Metrics Bar Graph */}
            ...
            <div className="bg-white rounded-2xl border border-[#C7C4D8]/50 p-6 md:p-7 shadow-sm space-y-5 animate-card-4 print:border-gray-200">
              ...
              <div className="space-y-6">
                {recommendations.map((rec, i) => (
                  <div key={rec.id} className="border-b border-gray-100 pb-6 last:border-0 last:pb-0 space-y-3.5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5 text-xs">
                      {/* Defensif */}
                      <div className="bg-red-50/20 border border-red-100/60 p-3.5 rounded-xl text-gray-500">
                      ...
                      {/* Rekomendasi */}
                      <div className="bg-emerald-50/25 border border-emerald-100/60 p-3.5 rounded-xl text-gray-700 font-medium">
                        <span className="block text-[8px] font-extrabold text-emerald-700 mb-1.5 uppercase tracking-wider">
                    ...
                    {/* Tips */}
                    <div className="p-3.5 bg-indigo-50/20 border border-indigo-100/30 rounded-xl text-xs text-gray-500 flex items-start gap-2">
            ...
            {/* NEW WIDGET: Advanced Rhetorical Tips for Defense Day */}
            <div className="bg-gradient-to-tr from-[#3525cd]/5 to-indigo-50/10 rounded-2xl border border-indigo-100/60 p-6 shadow-sm space-y-4 animate-card-4">
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-[#3525cd] font-bold">campaign</span>
                <span className="text-xs font-extrabold text-[#0B1C30] uppercase tracking-wider">
                  Tips Retorika Lanjutan Untuk Hari Sidang
                </span>
              </div>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-[11px] text-gray-600">
                <div className="space-y-1">
                  <strong className="text-gray-800 block">1. Menghadapi Kritik Metodologi</strong>
                  <p className="leading-relaxed">Jangan mendebat secara emosional. Gunakan ungkapan pembuka: <em>"Terima kasih atas masukannya, naskah ini memang dibatasi oleh... namun justifikasi utama kami..."</em></p>
                </div>
                <div className="space-y-1">
                  <strong className="text-gray-800 block">2. Mengontrol Tempo Suara</strong>
                  <p className="leading-relaxed">Gunakan jeda 2 detik sebelum menjawab. Jeda menunjukkan ketenangan berpikir akademis dan memberi waktu menyusun argumen yang solid.</p>
                </div>
              </div>
            </div>
